        ...
        <body>
          <div class="container">
            ...
            <div class="section">
              ...
              <div class="field"><span class="label">Full Name:</span> <span class="value">${nutritionFullName || assessmentFullName || ''}</span></div>
              <div class="field"><span class="label">Email:</span> <span class="value">${email || ''}</span></div>
              <div class="field"><span class="label">Phone:</span> <span class="value">${phone || ''}</span></div>
              <div class="field"><span class="label">Gender:</span> <span class="value">${nutritionGender || gender || ''}</span></div>
              <div class="field"><span class="label">Date of Birth:</span> <span class="value">${nutritionDateOfBirth || dateOfBirth || ''}</span></div>
              <div class="field"><span class="label">Age:</span> <span class="value">${nutritionAge || assessmentAge || ''}</span></div>
              <div class="field"><span class="label">Height:</span> <span class="value">${nutritionHeight || height || ''}</span></div>
              <div class="field"><span class="label">Weight:</span> <span class="value">${nutritionWeight || weight || ''}</span></div>
              <div class="field"><span class="label">Fiverr Username:</span> <span class="value">${nutritionFiverrUsername || fiverrUsername || 'Not a Fiverr client'}</span></div>
            </div>
            ...
            <div class="section">
              ...
              <div class="field"><span class="label">Meals & Snacks per Day:</span> <span class="value">${mealsPerDay || ''}</span></div>
              <div class="field"><span class="label">Typical Eating Pattern:</span> <span class="value">${eatingPattern || ''}</span></div>
              <div class="field"><span class="label">Specific Diet:</span> <span class="value">${specificDiet || ''}</span></div>
              
              <h4 style="color: #2e7d32; margin-top: 20px;">Food Frequency:</h4>
              <div class="field"><span class="label">Fruits & Vegetables:</span> <span class="value">${fruitsVeggies || ''}</span></div>
              <div class="field"><span class="label">Whole Grains:</span> <span class="value">${wholeGrains || ''}</span></div>
              <div class="field"><span class="label">Lean Proteins:</span> <span class="value">${leanProteins || ''}</span></div>
              <div class="field"><span class="label">Dairy Products:</span> <span class="value">${dairy || ''}</span></div>
              <div class="field"><span class="label">Processed Foods:</span> <span class="value">${processed || ''}</span></div>
              <div class="field"><span class="label">Sugary Beverages:</span> <span class="value">${sugaryBeverages || ''}</span></div>
              
              <div class="field"><span class="label">Eat Out/Takeout Frequency:</span> <span class="value">${eatOut || ''}</span></div>
            </div>
            
            <!-- PART 4: HYDRATION -->
            <div class="section">
              <h3 class="section-title">💧 PART 4: HYDRATION</h3>
              <div class="field"><span class="label">Daily Water Intake:</span> <span class="value">${water || ''}</span></div>
              <div class="field"><span class="label">Other Beverages:</span> <span class="value">${otherBeverages || ''}</span></div>
              <div class="field"><span class="label">Beverages Details:</span> <span class="value">${beveragesSpecify || 'N/A'}</span></div>
              <div class="field"><span class="label">Past Diet Experiments:</span> <span class="value">${pastDiets || 'None'}</span></div>
            </div>
            ...
            <div class="section">
              ...
              <div class="field"><span class="label">Food Preferences (Enjoy/Dislike):</span> <span class="value">${foodPreferences || ''}</span></div>
              <div class="field"><span class="label">Dietary Restrictions:</span> <span class="value">${dietaryRestrictions || ''}</span></div>
              <div class="field"><span class="label">Restrictions Details:</span> <span class="value">${restrictionsSpecify || 'N/A'}</span></div>
              <div class="field"><span class="label">Barriers to Healthy Diet:</span> <span class="value">${barriers || ''}</span></div>
              <div class="field"><span class="label">Barriers Details:</span> <span class="value">${barriersSpecify || 'N/A'}</span></div>
            </div>
            
            <!-- PART 6: GOALS AND EXPECTATIONS -->
            <div class="section">
              <h3 class="section-title">🌟 PART 6: GOALS AND EXPECTATIONS</h3>
              <div class="field"><span class="label">Meal Prep Commitment (1-10):</span> <span class="value">${mealPrepCommitment || ''}</span></div>
              <div class="field"><span class="label">Meal Prep Explanation:</span> <span class="value">${mealPrepExplanation || ''}</span></div>
              <div class="field"><span class="label">Short-term & Long-term Goals:</span></div>
              <div class="value" style="white-space: pre-line; background: white; padding: 15px; border-radius: 5px; margin-top: 5px;">${nutritionGoals || ''}</div>
              
              <div class="field" style="margin-top: 20px;"><span class="label">Expectations from Nutrition Plan:</span></div>
              <div class="value" style="white-space: pre-line; background: white; padding: 15px; border-radius: 5px; margin-top: 5px;">${nutritionExpectations || ''}</div>
            </div>
            ...
            <div class="section">
              ...
              <div class="field"><span class="label">Package:</span> <span class="value">${selectedPackage}</span></div>
      ...
      await transporter.sendMail({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 30px;">
              <h2 style="color: #212121;">Thank you for completing your nutrition assessment, ${nutritionFullName || assessmentFullName || ''}!</h2>
